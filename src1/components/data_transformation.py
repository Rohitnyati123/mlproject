...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            ] # for concatenation of two array we use np.c_
            test_arr = np.c_[input_feature_test_arr, np.array(target_feature_test_df)] # for concatenation of two array we use np.c_
